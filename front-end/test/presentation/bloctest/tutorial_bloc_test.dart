...
void main() {
  ...
  group('TutorialBloc', () {
    blocTest<TutorialBloc, TutorialState>(
      ...
      build: () => TutorialBloc(mockTutorialRepository, mockLocalRepository,
    ...
    blocTest<TutorialBloc, TutorialState>(
      ...
      setUp: () {
        when(mockTutorialRepository.getAllTutorials()).thenAnswer(
            (realInvocation) => Future.value([tutorial, tutorial, tutorial]));
      },
      build: () => TutorialBloc(mockTutorialRepository, mockLocalRepository,
          mockEnrollementRepository),
      act: (bloc) => bloc.add(LoadAllTutorials(0)),
      expect: () => [
        TutorialLoadingState(0),
        AllTutorialsLoadedState([tutorial, tutorial, tutorial], 0)
      ],
    );
    ...
    blocTest<TutorialBloc, TutorialState>(
      ...
      setUp: () {
        when(mockTutorialRepository.getMyTutorials()).thenAnswer(
            (realInvocation) => Future.value([tutorial, tutorial, tutorial]));
      },
      build: () => TutorialBloc(mockTutorialRepository, mockLocalRepository,
          mockEnrollementRepository),
      ...
      expect: () => [
        TutorialLoadingState(0),
        MyTutorialsLoadedState([tutorial, tutorial, tutorial], 0)
      ],
    );
    ...
    blocTest<TutorialBloc, TutorialState>(
      ...
      setUp: () {
        when(mockTutorialRepository.getEnrolledTutorials()).thenAnswer(
            (realInvocation) => Future.value([tutorial, tutorial, tutorial]));
      },
      build: () => TutorialBloc(mockTutorialRepository, mockLocalRepository,
          mockEnrollementRepository),
      ...
      expect: () => [
        TutorialLoadingState(0),
        EnrolledTutorialsLoaded([tutorial, tutorial, tutorial], 0)
      ],
    );
    ...
    blocTest<TutorialBloc, TutorialState>(
      ...
      setUp: () {
        when(mockTutorialRepository.deleteTutorial(tutorialId: 1))
    ...
    blocTest<TutorialBloc, TutorialState>(
      ...
      setUp: () {
        when(mockEnrollementRepository.enroll(tutorialId: 1))
    ...
    blocTest<TutorialBloc, TutorialState>(
      ...
      setUp: () {
        when(mockEnrollementRepository.unenroll(tutorialId: 1))
            .thenAnswer((realInvocation) => Future.value(""));
        when(mockTutorialRepository.getAllTutorials()).thenAnswer(
            (realInvocation) => Future.value([tutorial, tutorial, tutorial]));
      },
    ...
    blocTest<TutorialBloc, TutorialState>(
      ...
      build: () => TutorialBloc(mockTutorialRepository, mockLocalRepository,
          mockEnrollementRepository),
      act: (bloc) => bloc.add(
          GotoUpdateTutorialEvent(TutorialFormModel.fromTutorial(tutorial), 0)),
      expect: () =>
          [UpdateTutorialState(TutorialFormModel.fromTutorial(tutorial), 2)],
    );
  });
}
